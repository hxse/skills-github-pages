...
# scoop
  ...
  ## 安装app
    ...
    * `scoop install alacritty`
      * `. "C:\Users\qmlib\scoop\apps\alacritty\current\install-context.reg"`
      * 新建 `%AppData%\Roaming\alacritty\alacritty.toml`
```
[mouse]
bindings = [
...
[font]
# 建议使用大小为 11 到 13 之间的值，视分辨率而定
size = 12.0

[font.normal]
# 这里填入你安装的字体名称，例如 "JetBrainsMono NF" 或 "Cascadia Code"
