...
# subconvert:
  ...
  * 第三方修改版, 这个支持协议更多
    * `docker run -d -p 22000:25500 --name subconverter --restart unless-stopped asdlokj1qpi23/subconverter:latest`
  * 官方原版, 目前支持协议有限
    * `docker run -d -p 22000:25500 --name subconverter --restart unless-stopped tindy2013/subconverter:latest`
