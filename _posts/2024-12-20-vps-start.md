...
```
{
  "models": [
    ...
    {
      "id": "gemini-2-flash-thinking-exp",
      "name": "gemini-2.0-flash-thinking-exp-01-21",
      "provider": "Google",
      "providerId": "gemini-2.0-flash-thinking-exp-01-21",
      "enabled": true,
      "toolCallType": "native"
    },
    {
...
```
  * `docker run --env-file ~/morphic/.env.local -p 3813:3000 -v ~/morphic/models.json:/app/public/config/models.json --name morphic ghcr.io/miurla/morphic:latest`
