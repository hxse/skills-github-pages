...
# subconvert:
  ...
  * 为了支持hy2, 不用官方的,用修改版的
  * 第三方修改版本这个支持协议更多
    * `docker run -d -p 22000:25500 --restart=unless-stopped asdlokj1qpi23/subconverter:latest`
  * 官方原版, 支持协议有限
    * `docker run -d -p 22000:25500 --restart=unless-stopped tindy2013/subconverter:latest`
